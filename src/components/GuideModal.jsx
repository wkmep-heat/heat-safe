...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { title: 'เลือกจุดเริ่มต้น', desc: 'แตะบนแผนที่ หรือแตะไอคอนสถานที่ (โรงเรียน/สวน/ห้าง/โรงพยาบาล/คาเฟ่) เพื่อเลือกจุดเริ่มต้น' },
      ...
      { title: 'เปิด-ปิดสถานที่บนแผนที่', desc: 'แถบด้านล่าง (มือถือ) หรือด้านขวา (คอม) เลือกแสดง/ซ่อนโรงเรียน สวน ห้าง โรงพยาบาล คาเฟ่' },
